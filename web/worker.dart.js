// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 3.0.2.
...
(function dartProgram() {
  ...
  (function installTearOffs() {
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 8, 0, 0);
    ...
    _instance(_, "get$addError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["addError$2", "addError$1"], 8, 0, 0);
    ...
    _instance_2_u(_, "get$_handleError", "_handleError$2", 30);
    ...
    _static_1(A, "delegates___defaultSavepoint$closure", "_defaultSavepoint", 5);
    _static_1(A, "delegates___defaultRelease$closure", "_defaultRelease", 5);
    _static_1(A, "delegates___defaultRollbackToSavepoint$closure", "_defaultRollbackToSavepoint", 5);
    _static_1(A, "sql_js_SqlJsModule_____tearOff$closure", "SqlJsModule_____tearOff", 51);
    _instance_1_u(_ = A._RunningDriftWorker.prototype, "get$_newConnection", "_newConnection$1", 76);
    ...
    _instance(A._GuaranteeSink.prototype, "get$_guarantee_channel$_addError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["_guarantee_channel$_addError$2", "_guarantee_channel$_addError$1"], 8, 0, 0);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(String,@)", "Null()", "~(Object?)", "~(@)", "String(int)", "@(@)", "Null(@)", "~(Object[StackTrace?])", "~(Object,StackTrace)", "~(@,@)", "~(Event)", "Null(Event)", "Future<~>()", "~(~())", "int(int)", "@(MessageEvent)", "bool()", "Null(@,StackTrace)", "int(int,int)", "Future<Null>()", "~(Uint8List,String,int)", "~(String,String)", "bool(~)", "Future<int>()", "~([Object?])", "@(String)", "~(String,int)", "~(String,int?)", "Uint8List(@,@)", "~(@,StackTrace)", "~(@[List<Object>?])", "Future<@>(@)", "~(int,@)", "Null(@,@)", "@(@,@)", "_Future<@>(@)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Future<~>(Request)", "Object?(Object?)", "int?(int)", "Null(~)", "@(Request)", "~(Object?,Object?)", "Future<@>()", "CancellationToken<@>?()", "Future<QueryResult>()", "Null(bool)", "Null(~())", "SqlJsModule(_SqlJs)", "Future<bool>()", "Map<String,@>(List<Object?>)", "~(Symbol0,@)", "~(VersionChangeEvent)", "Null(Object,StackTrace)", "StreamChannel<Object?>()", "SubscriptionStream<Object?>(Stream<Object?>)", "WebDatabase()", "@(@,String)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Object?(@)", "~(MessageEvent)", "int()"],
